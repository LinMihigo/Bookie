...
>(({ className, ...props }, ref) => (
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-white shadow-lg ring-0 transition-transform data-[state=checked]:transtone-x-5 data-[state=unchecked]:transtone-x-0 dark:bg-stone-950"
      )}
    />
  </SwitchPrimitives.Root>
))
